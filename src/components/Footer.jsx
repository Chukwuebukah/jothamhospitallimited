...
const Footer = () => {
  const footerLinks = {
    services: [
      ...
      { name: 'Expert Doctors', href: '#services' },
...
<div className="flex items-center space-x-4">
  ...
  <h3 className="text-2xl font-bold text-blue-400">Jotham Hospital Limited</h3>
</div>

            <p className="text-gray-400">
            We treat, God perfects.
        ...
        >
          <p className="text-gray-400">
            © {new Date().getFullYear()} Jotham Hospital Limited. All rights reserved.
          </p>
        </motion.div>
      </div>
    </footer>
